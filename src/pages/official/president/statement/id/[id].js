                            ...
                            <div className="row">
                                <div className="col-12">
                                    <div className="post-gallery-title">
                                        ...
                                        <h2>{presidentData[ID]?.heading}</h2>
                                    </div>
                                    <div className="post-gallery-author-meta">
                                        <div className="author-area">
                                            ...
                                            <div className="author-content">
                                                <p>By, <Link legacyBehavior href="/official/president/statement"><a>{presidentData[ID]?.name}</a></Link></p>
                                            </div>
                                        </div>
                            ...
                            <div className="row justify-content-center g-4">
                                <div className="col-lg-8">
                                    <blockquote className="text-center">
                                        <p className="blockquote-text">"{presidentData[ID]?.description}"</p>
                                        <h3 className="blockquote-author">{presidentData[ID]?.name}</h3>
                                    </blockquote>

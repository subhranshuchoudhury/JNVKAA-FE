...
import presidentData from '@/data/officials/head.json'
                            ...
                            <div className="row">
                                <div className="col-12">
                                    <div className="post-gallery-title">
                                        <span className="eg-badge2 badge--red">{presidentData[ID]?.title}</span>
                                        <h2 className={`${theme === "dark" ? "text-light" : ""}`}>{presidentData[ID]?.heading}</h2>
                                    </div>
                                    <div className="post-gallery-author-meta">
                                        <div className="author-area">
                                            <div className="author-img">
                                                <Image width={30} height={30} src={presidentData[ID]?.image} alt="" />
                                            </div>
                                            <div className="author-content">
                                                <p className={`${theme === "dark" ? "text-light" : ""}`}>By, <Link legacyBehavior href="/official/president/statement"><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>{presidentData[ID]?.name}</a></Link></p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="sidebar-thumb text-center">
                                        {/* 1320 x 595 */}
                                        <Image width={300} height={800} src={presidentData[ID]?.image} alt="" />
                                    </div>
                                </div>
                            </div>
                            <div className="row justify-content-center g-4">
                                <div className="col-lg-8">
                                    <blockquote className="text-center">
                                        <p className={`blockquote-text ${theme === "dark" ? "text-light" : ""}`}>"{presidentData[ID]?.description}"</p>
                                        <h3 className={`blockquote-author ${theme === "dark" ? "text-light" : ""}`}>{presidentData[ID]?.name}</h3>
                                    </blockquote>

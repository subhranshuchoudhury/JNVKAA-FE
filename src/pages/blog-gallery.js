      ...
      <div className="container-md container-fluid">
              ...
              <div key={id} className="col">
                <div className="blog-video-2 style-2">
                  ...
                  <div className="content">
                    <ul>
                      <li>
                        <Link legacyBehavior href="/author-details"><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>By {post_Auth}</a></Link>
                      </li>
                      <li>
                        <Link legacyBehavior href="/blog-standard"><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>{date}</a></Link>
                      </li>
                      <li className={`${theme === "dark" ? "text-light" : ""}`}>{post_view}</li>
                    </ul>
                    <h4>
                      <Link legacyBehavior href="/gallery-post-format"><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>{title}</a></Link>
                    </h4>
        ...
        <nav className="mt-60">
          <ul className="pagination-list">
            <li>
              <a href="#" className={`${theme === "dark" ? "border border-hover" : ""}`}>
                <i className={`bi bi-chevron-left ${theme === "dark" ? "text-light" : ""}` }/>
              </a>
            </li>
            <li>
              <a href="#" className={`${theme === "dark" ? "border border-hover text-light" : ""}`}>1</a>
            </li>
            <li>
            ...
            <li>
              <a href="#" className={`${theme === "dark" ? "border border-hover text-light" : ""}`}>3</a>
            </li>
            <li>
              <a href="#" className={`${theme === "dark" ? "border border-hover" : ""}`}>
                <i className={`bi bi-chevron-right ${theme === "dark" ? "text-light" : ""}` } />
              </a>
            </li>
          </ul>
        </nav>

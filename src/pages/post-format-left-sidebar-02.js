...
function PostFormatLeftSidebar02() {
  return (
    <section className="post-gallery-details style-5 mt-100">
      ...
      <div className="row justify-content-center g-4">
        ...
        <div className="col-lg-8">
          <div className="left-sidebar2-inner-img">
            ...
            <img src="assets/images/post-format/left-sidebar2-inner-img1.jpg" alt="" />
          </div>
          <div className="post-gallery-title">
            <h2>Our Begin Now Beingon Your.</h2>
          </div>
...
export default PostFormatLeftSidebar02

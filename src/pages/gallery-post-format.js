...
function GalleryPostFormat() {
  ...
  return (
    <section className="post-gallery-details mt-100">
  <div className="container">
    <div className="row">
      <div className="col-12">
        <div className="post-gallery-thumb mb-70">
          <div className="blog-slider-wrapper">
            <div className="blog-stand-next swiper-next-arrow" tabIndex={0} role="button" aria-label="Next slide">
              <i className="bi bi-arrow-right" />
            </div>
            <div className="blog-stand-prev swiper-prev-arrow" tabIndex={0} role="button" aria-label="Previous slide">
              <i className="bi bi-arrow-left" />
            </div>
            <Swiper {...slider} className="swiper post-gallery-card-slider">
              <div className="swiper-wrapper">
                <SwiperSlide className="swiper-slide">
                  <img src="assets/images/post-gallery-format/post-gallery-banner-img.jpg" alt="image" />
                </SwiperSlide>
                <SwiperSlide className="swiper-slide">
                  <img src="assets/images/post-gallery-format/post-gallery-banner-img2.jpg" alt="image" />
                </SwiperSlide>
                <SwiperSlide className="swiper-slide">
                  <img src="assets/images/post-gallery-format/post-gallery-banner-img3.jpg" alt="image" />
                </SwiperSlide>
                <SwiperSlide className="swiper-slide">
                  <img src="assets/images/post-gallery-format/post-gallery-banner-img4.jpg" alt="image" />
                </SwiperSlide>
              </div>
            </Swiper>
          </div>
    ...
    <div className="post-gallery-title">
      <span className="eg-badge2 badge--red">Creative</span>
      <h2>Our Begin Now To Beingonl What Yourmoi Will Be own fully gone.</h2>
    </div>
    <div className="post-gallery-author-meta">
      <div className="author-area">
        ...
        <div className="author-content">
          <p>By, <Link legacyBehavior href="/author-details"><a>Cooper Jogan</a></Link></p>
        </div>
      </div>
    ...
    <div className="post-gallery-content">
      <div className="row justify-content-center">
        <div className="col-lg-8">
          <p className="first-para">NSuspendisse bibendum efficitur orci, a pretium erat mattis nec. Vestibulum ante ypsumi primis inaetahsjanl faucibus orci luctus etenjot ultrices posuere cubilia curae; Curabitur.</p>
          <p className="second-para"> urna Aenean onewaryzo eleifend vitae tellus a facilisis. Nunc posuere at augue eget porta. Inei odio tellus, dignissim fermentumara purus nec, consequat dapibus metus.Vivamus urna worlda mauris, faucibus at egestas quis, fermentum egetonav neque. Duis pharetra lectus nec risusonl pellentesque, vitae aliquet nisi dapibus. Sed volutpat mi velit, ateng maximus est eleifend accui Fusce porttitor ex arcu. Phasellus viverra lorem a nibh placerat tincidunt.bolgotai Aliquam andit rutrum elementum urna, vel fringilla tellus varius ut. Morbi non velit odio.</p>
          <blockquote className="text-center">
            <p className="blockquote-text">"I work with Alguneb Johnl on many projects, he always toldagona exceeds my expectations with his quality work and fastestopa tope service, very smooth and simple communication."</p>
            <h3 className="blockquote-author">Leslie Alexander</h3>
          </blockquote>
          <p className="third-para">urna Aenean onewaryzo eleifend vitae tellus a facilisis. Nunc posuere at augue eget porta. Inei odio tellus, dignissim fermentumara purus nec, consequat dapibus metus.Vivamus urna worlda mauris, faucibus at egestas quis, fermentum egetonav neque. Duis pharetra lectus nec risusonl pellentesque, vitae aliquet nisi dapibus. Sed volutpat mi velit, ateng maximus est eleifend accui Fusce porttitor ex arcu. Phasellus viverra lorem a nibh placerat tincidunt.bolgotai Aliquam andit rutrum elementum urna, vel fringilla tellus varius ut. Morbi non velit odio.</p>
          <div className="row g-4">
            <div className="col-lg-4 col-md-4 col-sm-4">
              <div className="post-details-img">
                <img src="assets/images/post-gallery-format/post-details-img1.jpg" alt="" />
              </div>
            </div>
            <div className="col-lg-4 col-md-4 col-sm-4">
              <div className="post-details-img">
                <img src="assets/images/post-gallery-format/post-details-img2.jpg" alt="" />
              </div>
            </div>
            <div className="col-lg-4 col-md-4 col-sm-4">
              <div className="post-details-img">
                <img src="assets/images/post-gallery-format/post-details-img3.jpg" alt="" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="post-tags-social">
        <div className="row">
          <div className="col-lg-6 col-md-6 col-sm-10">
            <div className="tags">
              <ul>
                <li><Link legacyBehavior href="/blog-classic"><a><span>#</span> Artist</a></Link></li>
                <li><Link legacyBehavior href="/blog-classic"><a><span>#</span> Portfolio</a></Link></li>
                <li><Link legacyBehavior href="/blog-classic"><a><span>#</span> Crypto</a></Link></li>
                <li><Link legacyBehavior href="/blog-classic"><a><span>#</span> Digital Token</a></Link></li>
              </ul>
            </div>
          </div>
          <div className="col-lg-6 col-md-6 col-sm-10">
          ...
          <div className="details-navigation">
            <div className="single-navigation">
              <div className="content">
                <Link legacyBehavior href="/post-format-no-sidebar-01"><a>Previous</a></Link>
                <h4><Link legacyBehavior href="/post-format-no-sidebar-01"><a>Feugiat Varius Mattis Mass Enim Est Egestas.</a></Link></h4>
              </div>
              <Link legacyBehavior href="/post-format-no-sidebar-01">
                <a  className="img">
                <img src="assets/images/post-format/post-format-left-sidebar-img1.jpg" alt="" />
                <div className="arrow">
            ...
            <div className="single-navigation two">
              <Link legacyBehavior href="/post-format-no-sidebar-01">
                <a  className="img">
                <img src="assets/images/post-format/post-format-left-sidebar-img2.jpg" alt="" />
                <div className="arrow">
                  <svg width={12} height={12} viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 1H12M12 1V13M12 1L0.5 12" />
                  </svg>
              ...
              <div className="content">
                <Link legacyBehavior href="/post-format-no-sidebar-01"><a>NEXT</a></Link>
                <h4><Link legacyBehavior href="/post-format-no-sidebar-01"><a>Donec Finibus Laoreet Exte Eu Pellentesque.</a></Link></h4>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="col-lg-9">
          <div className="comment-section">
            ...
            <ul className="author-comment">
              <li>
                <div className="author-img">
                  <img src="assets/images/post-gallery-format/author-comment-img1.jpg" alt="" />
                </div>
                <div className="comment-content">
                  ...
                  <p>odio tellus, dignissim fermentumara purus nec, consequat dapibus metus.Vivamusut urna worlda mauris, faucibus at egestas quis, fermentum egetonav neque. Duisonajt pharetra lectus nec risusonl</p>
                  <a href>
              ...
              <li>
                <div className="author-img">
                  <img src="assets/images/post-gallery-format/author-comment-img2.jpg" alt="" />
                </div>
                <div className="comment-content">
                  <div className="comment-top">
                    <h5>Ezekiel Miles</h5>
            ...
            <form className="contact-form">
              <div className="row">
                ...
                <div className="col-12">
                  <button type="submit" className="eg-btn btn--primary btn--lg">Post a Comment</button>
                </div>
              </div>
            </form>
          </div>
...
export default GalleryPostFormat

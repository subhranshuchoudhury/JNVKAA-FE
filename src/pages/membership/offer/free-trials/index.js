      ...
      <div className="container">
        <div className="row gy-5">
          <div className="col-lg-12">
            ...
            <i>
              Note: You can activate membership by clicking on the coupon name.
              If you have any active premium membership then you can't redeem
              any free trials code.
            </i>
          </div>
        </div>
      </div>

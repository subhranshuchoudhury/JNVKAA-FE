                    ...
                    <div className="post-gallery-content">
                        <div className="row">
                            <div className="col-12">
                                <div className="post-gallery-title">
                                    <span className="eg-badge2 badge--red">{new Date(EventData?.created_at).toLocaleString()}</span>
                        ...
                        <div className="row justify-content-center g-4">
                            <div className="col-lg-8">
                                <p className="first-para">{EventData?.description}</p>
                                ...
                                <blockquote className="text-center">
                                    <p className="blockquote-text">{EventData?.location}</p>
                                    <h3 className="blockquote-author">Location</h3>
                                </blockquote>

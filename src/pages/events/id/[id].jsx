                    ...
                    <div className="post-gallery-content">
                        <div className="row">
                            <div className="col-12">
                                <div className="post-gallery-title">
                                    ...
                                    <h2 className={`${theme === "dark" ? "text-light" : ""}`}>{EventData?.name}</h2>
                                </div>
                                    ...
                                    <div className="post-meta">
                                        <ul>
                                            <li className={`${theme === "dark" ? "text-light" : ""}`}>
                                                ...
                                                </svg>{new Date(EventData?.created_at).toLocaleString()}
                                            </li>
                                            <li className={`${theme === "dark" ? "text-light" : ""}`}>
                                                <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" className={`${theme === "dark" ? "svg-fill" : ""}`}>
                        ...
                        <div className="row justify-content-center g-4">
                            <div className="col-lg-8">
                                <p className={`first-para ${theme === "dark" ? "text-light first-letter-in-dark" : ""}`}>{EventData?.description}</p>
                                ...
                                <blockquote className="text-center">
                                    <p className={`blockquote-text ${theme === "dark" ? "text-light" : ""}`}>{EventData?.location}</p>
                                    <h3 className={`blockquote-author ${theme === "dark" ? "text-light" : ""}`}>Location</h3>
                                </blockquote>
                        ...
                        <div className="post-tags-social">
                            <div className="row">
                                <div className="col-lg-6 col-md-6 col-sm-10">
                                    <div className="tags">
                                        <ul>
                                            <li><Link legacyBehavior href={`${EventData?.link}`}><a> <span>#</span> {EventData?.link}</a></Link></li>

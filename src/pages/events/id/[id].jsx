              ...
              <div className="row">
                <div className="col-12">
                  <div className="post-gallery-title">
                    <span className="eg-badge2 badge--red">
                  ...
                  <div className="post-gallery-author-meta">
                    <div className="author-area">
                      <div className="author-img">
                        <Image
                          src="/assets/images/dummy/avatar/user.jpg"
                          width={30}
                          height={30}
                          alt=""
                        />
                  ...
                  <div className="sidebar-thumb text-center">
                    {/* 
                                          GLOBAL_URL + "/api/user/post/image/" + EventData.image
                                          */}
                    {EventData?.image ? (
                      <Image
                        width={500}
                ...
                <div className="col-lg-8">
                  <p
                    className={`first-para ${
                      theme === "dark" ? "text-light first-letter-in-dark" : ""
                    }`}
                  >
                ...
                <div className="row">
                  <div className="col-lg-6 col-md-6 col-sm-10">
                    <div className="tags">
                      <ul>
                        <li>
                          <Link legacyBehavior href={`${EventData?.link}`}>
                            <a>
                              {" "}
                              <span>#</span> {EventData?.link}
                            </a>
                          </Link>
                        </li>
                      </ul>

...
function PostFormatNoSidebar02Page() {
  return (
    <>
      ...
      <div className="row justify-content-center g-4">
        <div className="col-lg-8">
          ...
          <div className="row g-4">
            ...
            <div className="col-md-4 col-sm-6">
              <div className="sidebar-dt-img">
                <img src="assets/images/post-format/post-format-left-sidebar-img3.jpg" alt="" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="details-navigation">
            <div className="single-navigation">
              ...
              <Link legacyBehavior href="/post-format-no-sidebar-01">
               <a  className="img"> <img src="assets/images/post-format/post-format-left-sidebar-img1.jpg" alt="" />
                <div className="arrow">
            ...
            <div className="single-navigation two">
              <Link legacyBehavior href="/post-format-no-sidebar-01">
                <a  className="img"><img src="assets/images/post-format/post-format-left-sidebar-img2.jpg" alt="" />
                <div className="arrow">
                  <svg width={12} height={12} viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 1H12M12 1V13M12 1L0.5 12" />
                  </svg>
...
export default PostFormatNoSidebar02Page

                                        ...
                                        return <div key={post._id} className="col-md-6">
                                            <div className="blog-grid-1">
                                                ...
                                                <div className="content">
                                                    ...
                                                    <h4><Link legacyBehavior href={`/posts/alumni/id/${post._id}`}><a>{post?.title}.</a></Link></h4>
                                                    <div className="bottom-area">
                                                        <Link legacyBehavior href={`/posts/alumni/id/${post._id}`}><a className=" eg-btn arrow-btn">View Details<i className="bi bi-arrow-right" /></a></Link>
                                    ...
                                    <ul className="category-list">

                                        {
                                            categoriesPost?.map((category, index) => {
                                                return <li key={index}><Link legacyBehavior href="/posts/alumni">
                                                    <a>

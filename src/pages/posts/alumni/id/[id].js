...
export default function page() {
    ...
    return <>
        {
            Loading && AlumniPost.length > 0 ? <div class="d-flex justify-content-center">
                    ...
                    <div className="post-gallery-content">
                        ...
                        <div className="row justify-content-center g-4">
                            <div className="col-lg-8">
                                <p className="first-para">{AlumniPost?.description}</p>
                                ...
                                <blockquote className="text-center">
                                    <p className="blockquote-text">{AlumniPost?.author?.name}</p>
                                    <h3 className="blockquote-author">Author</h3>
                                </blockquote>

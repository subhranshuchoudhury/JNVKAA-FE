...
export default function page() {
    ...
    const loadAlumniPost = async (ID) => {
        ...
        const res = await getAlumniPostByID(ID);
        console.log(res);
        setAlumniPost(res?.data);
        setLoading(false);
    }
                    ...
                    <div className="post-gallery-content">
                        <div className="row">
                            <div className="col-12">
                                <div className="post-gallery-title">
                                    <span className="eg-badge2 badge--red">{new Date(AlumniPost?.date).toDateString()}</span>
                                    <h2 className={`${theme === "dark" ? "text-light" : ""}`}>{AlumniPost?.title}</h2>
                                </div>
                                <div className="post-gallery-author-meta">
                                    <div className="author-area">
                                        ...
                                        <div className="author-content">
                                            <p className={`${theme === "dark" ? "text-light" : ""}`}>By, {AlumniPost?.author?.name}</p>
                                        </div>
                                    </div>
                                    <div className="post-meta">
                                        <ul>
                                            <li className={`${theme === "dark" ? "text-light" : ""}`}>
                                                ...
                                                </svg>{new Date(AlumniPost?.timestamp).toLocaleString()}
                                            </li>
                                            <li className={`${theme === "dark" ? "text-light" : ""}`}>
                                                <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" className={`${theme === "dark" ? "svg-fill" : ""}`}>
                        ...
                        <div className="row justify-content-center g-4">
                            <div className="col-lg-8">
                                <p className={`first-para ${theme === "dark" ? "text-light first-letter-in-dark" : ""}`}>{AlumniPost?.description}</p>
                                ...
                                <blockquote className="text-center">
                                    <p className={`blockquote-text ${theme === "dark" ? "text-light" : ""}`}>{AlumniPost?.author?.name}</p>
                                    <h3 className={`blockquote-author ${theme === "dark" ? "text-light" : ""}`}>Author</h3>
                                </blockquote>
                        ...
                        <div className="post-tags-social">
                            <div className="row">
                                <div className="col-lg-6 col-md-6 col-sm-10">
                                    <div className="tags">
                                        <ul>
                                            <li><Link legacyBehavior href={`${AlumniPost?.link}`}><a> <span>#</span> {AlumniPost?.link}</a></Link></li>

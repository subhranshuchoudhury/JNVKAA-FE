...
import { GLOBAL_URL, getAlumniMeetsPostById, isValidateInputID } from '@/utils/fetch';
...
export default function page() {
    ...
    const loadEvents = async (ID) => {
        ...
        if (isValidateInputID(ID)) {
            ...
            const res = await getAlumniMeetsPostById(ID);
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="post-gallery-title">
                                    ...
                                    <h2 className={`${theme === "dark" ? "text-light" : ""}`}>{EventData?.title}</h2>
                                </div>
                                <div className="post-gallery-author-meta">
                                    <div className="author-area">
                                        <div className="author-img">
                                            <Image width={30} height={30} src="/assets/images/dummy/avatar/user.jpg" alt="" />
                                        </div>

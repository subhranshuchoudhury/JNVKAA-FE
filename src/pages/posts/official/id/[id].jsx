    ...
    return <>

        {
            Loading ? <div className="d-flex justify-content-center">
                    ...
                    <div className="post-gallery-content">
                        ...
                        <div className="row justify-content-center g-4">
                            <div className="col-lg-8">
                                <p className="first-para">{OfficialPost?.description}</p>
                                <blockquote className="text-center">
                                    <p className="blockquote-text">{OfficialPost?.author?.name}</p>
                                    <h3 className="blockquote-author">Official</h3>
                                </blockquote>
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-10">
                                    <div className="tags">
                                        <ul>
                                            ...
                                            <li><Link legacyBehavior href={`${OfficialPost?.link}`}><a> <span>@</span> MODERATOR ID: {OfficialPost?.author?.id}</a></Link></li>
                ...
                <h1>The content has been removed or not found. 😿</h1>
            </div>
        }
    </>
}

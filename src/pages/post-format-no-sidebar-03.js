...
function PostFormatNoSidebar03Page() {
  return (
    <section className="post-gallery-details style-3 mt-50">
    <div className="container">
      ...
      <div className="row">
        <div className="col-12">
          <div className="post-gallery-thumb mb-60">
            <img src="assets/images/post-format/Post-format-thumb-03.jpg" alt="" />
          </div>
        </div>
      </div>
          ...
          <div className="col-lg-12">
            <div className="details-navigation">
              ...
              <div className="single-navigation two">
                ...
                <div className="content">
                  <Link legacyBehavior href="/post-format-no-sidebar-01.htm"><a>NEXT</a></Link>
...
export default PostFormatNoSidebar03Page

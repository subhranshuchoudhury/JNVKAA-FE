...
function PostFormatnoSidebar05Page() {
  return (
    <section className="post-gallery-details style-7 mt-100">
              ...
              <div className="col-lg-3 p-lg-0">
                <div className="author-sidebar">
                  <div className="author-sidebar-img">
                    <img src="/assets/images/post-format/author-sidebar-img2.jpg" alt="" />
                  </div>
                  <div className="author-sidebar-content">
                    <div className="author-title">
                      <h5><Link legacyBehavior href="/author-details"><a>Ericol Patrick</a></Link></h5>
                      <span>Creative</span>
                    </div>
              ...
              <div className="col-lg-9 p-lg-0">
                <div className="post-thumb">
                  <div className="post-thumb-title">
                    <span>Creative</span>
                    <h2>Our Begin Now To Beingon lowte Your ani Will Be.</h2>
                  </div>
                  <div className="post-thumb-img">
                    <img src="/assets/images/post-format/post-thumb-img.jpg" alt="" />
...
export default PostFormatnoSidebar05Page

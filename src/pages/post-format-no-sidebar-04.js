...
function PostFormatNoSidebar04Page() {
  return (
    <section className="post-gallery-details style-8 mt-50">
  <div className="container">
    <div className="post-format-wrapper">
      <div className="row">
        <div className="col-md-12">
          <div className="post-thumb">
            <img src="assets/images/post-format/post-format04-thumb-img.png" alt="" />
        ...
        <div className="col-md-12">
          <div className="post-gallery-title">
            <h2>Our Begin Now To Beingon lowter Your ani Will Be.</h2>
          </div>
          ...
          <div className="details-navigation">
            <div className="single-navigation">
              <div className="content">
                <Link legacyBehavior href="/post-format-no-sidebar-04"><a>Previous</a></Link>
                <h4><Link legacyBehavior href="/post-format-no-sidebar-04"><a>Feugiat Varius Mattis Mass Enim Est Egestas.</a></Link></h4>
              </div>
              <Link legacyBehavior href="/post-format-no-sidebar-04">
                <a  className="img">
                <img src="assets/images/post-format/post-format-left-sidebar-img1.jpg" alt="" />
                <div className="arrow">
            ...
            <div className="single-navigation two">
              ...
              <div className="content">
                <Link legacyBehavior href="/post-format-no-sidebar-04"><a>NEXT</a></Link>
                <h4><Link legacyBehavior href="/post-format-no-sidebar-04"><a>Donec Finibus Laoreet Exte Eu Pellentesque.</a></Link></h4>
              </div>
            </div>
          </div>
        </div>
...
export default PostFormatNoSidebar04Page

...
function PostFormatLeftSidebar03Page() {
  return (
    <>
    <section className="post-format-inner-banner mb-100">
  <div className="container">
    <div className="row">
      <div className="col-lg-12">
        <div className="post-gallery-title pt-100 mt-100">
        ...
        <div className="post-gallery-author-meta">
          <div className="author-area">
            ...
            <div className="author-content">
              <p>By, <a href="author-details.html">Cooper Jogan</a></p>
            </div>
          </div>
...
export default PostFormatLeftSidebar03Page

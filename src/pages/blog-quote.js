          ...
          <div className="col">
            <div className="blog-video-2 style-2">
              ...
              <div className="content">
                ...
                <h4><Link legacyBehavior href="/"><a>Cras congue est eget nisi lacinia non sagittis.</a></Link>
                </h4>
          ...
          <div className="col">
            <div className="blog-video-2 style-2">
              ...
              <div className="content">
                ...
                <h4><Link legacyBehavior href="/"><a>Nam mauris mauris rutum ultricies nonme.</a></Link>
                </h4>
                <div className="bottom-area">
                  <Link legacyBehavior href="/"><a className=" eg-btn arrow-btn">View Details<i className="bi bi-arrow-right" /></a></Link>
                  <span> <svg width={9} height={12} viewBox="0 0 9 12" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="col">
            <div className="blog-video-2 style-2">
              ...
              <div className="content">
                ...
                <h4><Link legacyBehavior href="/"><a>Proin ultrices lacus sedal convallis placerat.</a></Link>
                </h4>
                <div className="bottom-area">
                  <Link legacyBehavior href="/"><a className=" eg-btn arrow-btn">View Details<i className="bi bi-arrow-right" /></a></Link>
                  <span> <svg width={9} height={12} viewBox="0 0 9 12" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="col">
            <div className="blog-video-2 style-2">
              ...
              <div className="content">
                ...
                <h4><Link legacyBehavior href="/"><a>Laoreet ligula mauris nec velit. Nullam.</a></Link>
                </h4>
                <div className="bottom-area">
                  <Link legacyBehavior href="/"><a className=" eg-btn arrow-btn">View Details<i className="bi bi-arrow-right" /></a></Link>
                  <span> <svg width={9} height={12} viewBox="0 0 9 12" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="col">
            <div className="blog-video-2 style-2">
              ...
              <div className="content">
                ...
                <h4><Link legacyBehavior href="/"><a>Consectetur adipi scingoi elitInte rdumet.</a></Link>
                </h4>
                <div className="bottom-area">
                  <Link legacyBehavior href="/"><a className=" eg-btn arrow-btn">View Details<i className="bi bi-arrow-right" /></a></Link>
                  <span> <svg width={9} height={12} viewBox="0 0 9 12" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="col">
            <div className="blog-video-2 style-2">
              ...
              <div className="content">
                ...
                <h4><Link legacyBehavior href="/"><a>Cras bibendum lacus dict nulla vehicula.</a></Link>
                </h4>
                <div className="bottom-area">
                  <Link legacyBehavior href="/"><a className=" eg-btn arrow-btn">View Details<i className="bi bi-arrow-right" /></a></Link>
                  <span> <svg width={9} height={12} viewBox="0 0 9 12" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="col">
            <div className="blog-video-2 style-2">
              ...
              <div className="content">
                ...
                <h4><Link legacyBehavior href="/"><a>euismod vitae sapien act ultricies egestas.</a></Link>
                </h4>
                <div className="bottom-area">
                  <Link legacyBehavior href="/"><a className=" eg-btn arrow-btn">View Details<i className="bi bi-arrow-right" /></a></Link>
                  <span> <svg width={9} height={12} viewBox="0 0 9 12" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="col">
            <div className="blog-video-2 style-2">
              ...
              <div className="content">
                ...
                <h4><Link legacyBehavior href="/"><a>vestibulum Mecenas utot congue lectus.</a></Link>
                </h4>
                <div className="bottom-area">
                  <Link legacyBehavior href="/"><a className=" eg-btn arrow-btn">View Details<i className="bi bi-arrow-right" /></a></Link>
                  <span> <svg width={9} height={12} viewBox="0 0 9 12" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="col">
            <div className="blog-video-2 style-2">
              ...
              <div className="content">
                ...
                <h4><Link legacyBehavior href="/"><a>Our Begin Now To Being What You Will Be.</a></Link>
                </h4>
                <div className="bottom-area">
                  <Link legacyBehavior href="/"><a className=" eg-btn arrow-btn">View Details<i className="bi bi-arrow-right" /></a></Link>
                  <span> <svg width={9} height={12} viewBox="0 0 9 12" xmlns="http://www.w3.org/2000/svg">

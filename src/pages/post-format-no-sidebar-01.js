...
function PostFormatNoSidebar01Page() {
  return (
    <section className="post-gallery-details style-6 mt-100">
      ...
      <div className="row">
        <div className="col-lg-9">
          <div className="comment-section">
            ...
            <ul className="author-comment mb-120">
              <li>
                <div className="author-img">
...
export default PostFormatNoSidebar01Page

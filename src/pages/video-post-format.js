...
function VideoPostFormat() {
  ...
  return (
    <section className="post-gallery-details style-2 mt-100">
  <div className="container">
    <div className="row">
      <div className="col-12">
        <div className="post-gallery-thumb mb-70">
          <div className="video position-relative">
            <div className="video-play sibling-1">
              <div onClick={()=>setOpen(true)}
               data-fancybox="popup-youtube"><i className="bx bx-play" /></div>
            </div>
            <img src="assets/images/video-post-format/video-post-format-thumb.jpg" alt="" />
          </div>
        </div>
      </div>
    </div>
          ...
          <div className="row justify-content-center g-4">
            <div className="col-lg-4 col-md-4 col-sm-6">
              <div className="video position-relative">
                ...
                <img src="assets/images/video-post-format/video-post-format-video-img1.jpg" alt="" />
              </div>
            </div>
            <div className="col-lg-4 col-md-4 col-sm-6">
              <div className="video position-relative">
                <div className="video-play sibling-2">
                  <a data-fancybox="popup-youtube"><i className="bx bx-play" /></a>
                </div>
                <img src="assets/images/video-post-format/video-post-format-video-img2.jpg" alt="" />
              </div>
            </div>
            <div className="col-lg-4 col-md-4 col-sm-6">
              <div className="video position-relative">
                ...
                <img src="assets/images/video-post-format/video-post-format-video-img3.jpg" alt="" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="details-navigation">
            <div className="single-navigation">
              <div className="content">
                <a href="#">Previous</a>
                <h4><a href="#">Feugiat Varius Mattis Mass Enim Est Egestas.</a></h4>
              </div>
            ...
            <div className="single-navigation two">
              ...
              <div className="content">
                <a href="#">NEXT </a>
                <h4><a href="#">Donec Finibus Laoreet Exte Eu Pellentesque.</a></h4>
              </div>
            </div>
          </div>
        </div>
...
export default VideoPostFormat

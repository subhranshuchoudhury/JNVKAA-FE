  ...
  return (
    <section className="update pb-100">
      <div className="container">
        <div className={`update-wrapper ${theme === "dark" ? "bg-dark border border-white" : ""}`}>
          ...
          <div className="update-content">
            <div className="section-title-1">
              <div className="subtitle justify-content-center">
                ...
                <span className={`${theme === "dark" ? "text-light" : ""}`}>&nbsp;Get Every Update</span>
              </div>
              <h2 className={`${theme === "dark" ? "text-light" : ""}`}>Become A Member And Share Your Great Stories.</h2>
            </div>
            <a href="/auth/register" className="eg-btn btn--primary btn--lg">Become A Member</a>
          </div>

          ...
          <div className="col-lg-8 posittion-relative">
            <div className="slider-arrows arrow-style-1 sibling-three text-center d-flex flex-row justify-content-center align-items-center gap-4">
              <div className="blog-multi-next swiper-next-arrow" tabIndex={0} role="button" aria-label="Next slide">
                <i className={`bi bi-arrow-left ${theme === "dark" ? "bg-transparent text-light border border-white rounded-circle background-hover" : ""}`} />
              </div>
              <div className="blog-multi-prev swiper-prev-arrow" tabIndex={0} role="button" aria-label="Previous slide">
                <i className={`bi bi-arrow-right ${theme === "dark" ? "bg-transparent text-light border border-white rounded-circle background-hover" : ""}`} />
              </div>
            </div>
              ...
              <div className="swiper-wrapper">
                <SwiperSlide className="swiper-slide">
                  <div className="section-title-1 mb-40">
                    <h2 className={`${theme === "dark" ? "text-light" : ""}`}>Recent Events</h2>
                    {
                      Loading && <div className={`spinner-border text-${theme === "dark" ? "light" : "primary"} m-2`} role="status">
                    ...
                    <div className="subtitle">
                      ...
                      <span className={`${theme === "dark" ? "text-light" : "" }`}>&nbsp;Events</span>
                    </div>
                  </div>
                  <div className="search-area">
                    <span className={`tag-name ${theme === "dark" ? darkTheme : ""}`}>Events</span>
                  ...
                  {/* blog-list */}
                  {
                    RecentEvents?.length > 0 && RecentEvents.map((item, index) => (
                      <div key={index} className="blog-list-2">
                        <div className={`date ${theme === "dark" ? "circle-color" : ""}`}>
                        ...
                        <div className="content">
                          <ul>
                            <li><Link legacyBehavior href={`/events/id/${item?._id}`}><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>By Moderator</a></Link></li>
                            <li><Link legacyBehavior href={`/events/id/${item?._id}`}><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>{new Date(item?.created_at).toLocaleString()}</a></Link></li>
                          </ul>
                          <h4><Link legacyBehavior href={`/events/id/${item?._id}`}><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>{item?.name}</a></Link></h4>
                          <div className="bottom-area">
                            <Link legacyBehavior href={`/events/id/${item?._id}`}><a className={`eg-btn arrow-btn ${theme === "dark" ? "text-light" : ""}`}>View Event<i className="bi bi-arrow-right" /></a></Link>
                            <span><svg width={20} height={20} viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" fill={`${theme === "dark" ? "#fff" : "#000000"}`}><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path  fill={`${theme === "dark" ? "#fff" : "#000000"}`} d="M800 416a288 288 0 1 0-576 0c0 118.144 94.528 272.128 288 456.576C705.472 688.128 800 534.144 800 416zM512 960C277.312 746.688 160 565.312 160 416a352 352 0 0 1 704 0c0 149.312-117.312 330.688-352 544z"></path><path  fill={`${theme === "dark" ? "#fff" : "#000000"}`} d="M512 448a64 64 0 1 0 0-128 64 64 0 0 0 0 128zm0 64a128 128 0 1 1 0-256 128 128 0 0 1 0 256zm345.6 192L960 960H672v-64H352v64H64l102.4-256h691.2zm-68.928 0H235.328l-76.8 192h706.944l-76.8-192z"></path></g></svg> {item?.location}</span>
                          </div>
                        </div>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="section-title-1 mb-40">
                    <h2 className={`${theme === "dark" ? "text-light":""}`}>Youtube Videos</h2>
                    <div className="subtitle">
                      <svg width={11} height={14} viewBox="0 0 11 14" xmlns="http://www.w3.org/2000/svg" className={`${theme === "dark" ? "svg-fill" : ""}`}>
                        <path d="M7.15888 13.1844C8.73336 10.6029 8.07416 7.35423 5.59136 5.46029C5.58991 5.45922 5.58846 5.45788 5.5873 5.45708L5.59803 5.48172L5.59629 5.5002C6.08003 6.68033 6.01217 7.97589 5.41793 9.08745L4.99915 9.87117L4.87068 9.00522C4.78338 8.41784 4.54354 7.85751 4.17407 7.3778H4.11578L4.08503 7.29744C4.08938 8.19499 3.88464 9.07915 3.48297 9.91322C2.95602 11.0047 3.03345 12.2633 3.69033 13.2806L4.14362 13.9829L3.3281 13.6647C1.98331 13.1399 0.908237 12.1291 0.378384 10.8914C-0.215271 9.50931 -0.105357 7.90679 0.672747 6.6056C1.07847 5.92875 1.36269 5.21012 1.51784 4.46926L1.66952 3.74314L2.0564 4.39079C2.24113 4.69961 2.37715 5.03388 2.46154 5.38503L2.47024 5.39333L2.47923 5.44958L2.48765 5.44717C3.64654 4.02518 4.34083 2.25579 4.44204 0.464176L4.46814 0L4.88982 0.253917C6.61075 1.28967 7.80589 2.95139 8.17508 4.81853L8.18349 4.85684L8.18784 4.86273L8.20669 4.83809C8.54398 4.42668 8.72204 3.93732 8.72204 3.42226V2.62461L9.2432 3.26048C10.4549 4.73845 11.0761 6.57185 10.9926 8.42319C10.8899 10.6024 9.6031 12.5151 7.5501 13.5514L6.66121 14L7.15888 13.1844Z" />
                      </svg>
                      <span className={`${theme === "dark" ? "text-light":""}`}>&nbsp;Emerging Talents</span>
                    </div>
                  </div>
                  <div className="search-area">
                    <span className={`tag-name ${theme === "dark" ? darkTheme : ""}`}>Youtube</span>
                    <div className="search-form">
...

                  {
                    YoutubeResponse?.length > 0 && YoutubeResponse.map((item, index) => (
                      <div key={index} className="blog-list-2">
                        ...
                        <div className="content">
                          <ul>
                            <li><Link legacyBehavior href="/"><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>By Moderator</a></Link></li>
                            <li><Link legacyBehavior href={"/posts/youtube/id/" + item?._id}><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>Youtube</a></Link></li>
                          </ul>
                          <h4><Link legacyBehavior href={"/posts/youtube/id/" + item?._id}><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>{item?.title}</a></Link></h4>
                          <div className="bottom-area">
                            <Link legacyBehavior href={"/posts/youtube/id/" + item?._id}><a className={`eg-btn arrow-btn ${theme === "dark" ? "text-light" : ""}`}>View Details<i className="bi bi-arrow-right" /></a></Link>
                            <span> <svg width={9} height={12} viewBox="0 0 9 12" xmlns="http://www.w3.org/2000/svg" className={`${theme === "dark" ? "svg-fill" : ""}`}>
                        ...
                        <div className="image">
                          <div className="video position-relative">
                            ...
                            <img src={`https://img.youtube.com/vi/${item?.link}/0.jpg`} alt="image" />
                          </div>
                        </div>
                      </div>
                    ))
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="section-title-1 mb-40">
                    <h2 className={`${theme === "dark" ? "text-light" : ""}`}>Alumni Meets</h2>
                    <div className="subtitle">
                      <svg width={11} height={14} viewBox="0 0 11 14" xmlns="http://www.w3.org/2000/svg" className={`${theme === "dark" ? "svg-fill" : ""}`}>
                        <path d="M7.15888 13.1844C8.73336 10.6029 8.07416 7.35423 5.59136 5.46029C5.58991 5.45922 5.58846 5.45788 5.5873 5.45708L5.59803 5.48172L5.59629 5.5002C6.08003 6.68033 6.01217 7.97589 5.41793 9.08745L4.99915 9.87117L4.87068 9.00522C4.78338 8.41784 4.54354 7.85751 4.17407 7.3778H4.11578L4.08503 7.29744C4.08938 8.19499 3.88464 9.07915 3.48297 9.91322C2.95602 11.0047 3.03345 12.2633 3.69033 13.2806L4.14362 13.9829L3.3281 13.6647C1.98331 13.1399 0.908237 12.1291 0.378384 10.8914C-0.215271 9.50931 -0.105357 7.90679 0.672747 6.6056C1.07847 5.92875 1.36269 5.21012 1.51784 4.46926L1.66952 3.74314L2.0564 4.39079C2.24113 4.69961 2.37715 5.03388 2.46154 5.38503L2.47024 5.39333L2.47923 5.44958L2.48765 5.44717C3.64654 4.02518 4.34083 2.25579 4.44204 0.464176L4.46814 0L4.88982 0.253917C6.61075 1.28967 7.80589 2.95139 8.17508 4.81853L8.18349 4.85684L8.18784 4.86273L8.20669 4.83809C8.54398 4.42668 8.72204 3.93732 8.72204 3.42226V2.62461L9.2432 3.26048C10.4549 4.73845 11.0761 6.57185 10.9926 8.42319C10.8899 10.6024 9.6031 12.5151 7.5501 13.5514L6.66121 14L7.15888 13.1844Z" />
                      </svg>
                      <span className={`${theme === "dark" ? "text-light" : ""}`}>&nbsp;Alumni get-together</span>
                    </div>
                  </div>
                  <div className="search-area">
                    <span className={`tag-name ${theme === "dark" ? darkTheme : ""}`}>Events</span>
                  ...
                  {/* blog-list */}
                  {
                    AlumniMeet?.length > 0 && AlumniMeet.map((item, index) => (
                      <div key={index} className="blog-list-2">
                        ...
                        <div className="content">
                          <ul>
                            <li><Link legacyBehavior href={`/posts/alumni/alumni-meet/id/${item?._id}`}><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>By Moderator</a></Link></li>
                            <li><Link legacyBehavior href={`/posts/alumni/alumni-meet/id/${item?._id}`}><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>{new Date(item?.created_at).toLocaleString()}</a></Link></li>
                          </ul>
                          <h4><Link legacyBehavior href={`/posts/alumni/alumni-meet/id/${item?._id}`}><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>{item?.title}</a></Link></h4>
                          <div className="bottom-area">
                            <Link legacyBehavior href={`/posts/alumni/alumni-meet/id/${item?._id}`}><a className={`eg-btn arrow-btn ${theme === "dark" ? "text-light" : ""}`}>View Event<i className="bi bi-arrow-right" /></a></Link>
                            <span><svg width={20} height={20} viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" fill={`${theme === "dark" ? "#fff" : "#000000"}`}><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path  fill={`${theme === "dark" ? "#fff" : "#000000"}`} d="M800 416a288 288 0 1 0-576 0c0 118.144 94.528 272.128 288 456.576C705.472 688.128 800 534.144 800 416zM512 960C277.312 746.688 160 565.312 160 416a352 352 0 0 1 704 0c0 149.312-117.312 330.688-352 544z"></path><path  fill={`${theme === "dark" ? "#fff" : "#000000"}`} d="M512 448a64 64 0 1 0 0-128 64 64 0 0 0 0 128zm0 64a128 128 0 1 1 0-256 128 128 0 0 1 0 256zm345.6 192L960 960H672v-64H352v64H64l102.4-256h691.2zm-68.928 0H235.328l-76.8 192h706.944l-76.8-192z"></path></g></svg> {item?.location}</span>
                          </div>
                        </div>
          ...
          <div className="col-lg-4">
            <div className="post-side-bar-1">
              <div className="sidebar-widget-1">
                <h6 className={`title ${theme === "dark" ? "text-light" : ""}`}>Upcoming Events</h6>
                <div className="blog-list-1 mb-25">
                  <Link legacyBehavior href="/">
                    <a className="image"> <img src="/assets/images/events/web-push-notifications-small.jpg" alt="image" /></a>

                  </Link>
                  <div className="content">
                    <h6><Link legacyBehavior href="/"><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>Alumni Meet 2023 will be on 25th Dec 2023</a></Link></h6>
                    <ul>
                      <li><Link legacyBehavior href="/"><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>Dec 18, 2023</a></Link></li>
                      <li><Link legacyBehavior href="/"><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>Important</a></Link></li>
                    </ul>
                  </div>
                </div>
              </div>
                ...
                <ul className="social-3">

                  {
                    Socials.map((item, index) => (
                      <li key={index}>
                        <a href={item?.link}><span className={`${theme === "dark" ? "text-light" : ""}`}><i className={`${item?.icon} ${theme === "dark" ? "text-light" : ""}`} />{item?.platform}</span><span><strong className={`${theme === "dark" ? "text-light" : ""}`}>VISIT</strong>
                          &nbsp;</span></a>
                      </li>
                    ))
                  }

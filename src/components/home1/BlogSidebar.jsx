                    ...
                    RecentEvents?.length > 0 && RecentEvents.map((item, index) => (
                      <div key={index} className="blog-list-2">
                        ...
                        <Link legacyBehavior href={`/events/id/${item?._id}`}>
                          <a className="image">
                            <img src="https://static.vecteezy.com/system/resources/previews/000/410/289/original/vector-illustration-of-notification-icon-on-blue-background.jpg" alt="" />
                          </a>
                        </Link>
                      </div>
                    ))
...

                  {
                    YoutubeResponse?.length > 0 && YoutubeResponse.map((item, index) => (
                      <div key={index} className="blog-list-2">
                        ...
                        <div className="content">
                          <ul>
                            <li><Link legacyBehavior href="/"><a>By Moderator</a></Link></li>
                            <li><Link legacyBehavior href={"/posts/youtube/id/" + item?._id}><a>Youtube</a></Link></li>
                          </ul>
                          <h4><Link legacyBehavior href={"/posts/youtube/id/" + item?._id}><a>{item?.title}</a></Link></h4>
                          <div className="bottom-area">
                            <Link legacyBehavior href={"/posts/youtube/id/" + item?._id}><a className=" eg-btn arrow-btn">View Details<i className="bi bi-arrow-right" /></a></Link>
            ...
            <div className="post-side-bar-1">
              <div className="sidebar-widget-1">
                ...
                <div className="blog-list-1 mb-25">
                  ...
                  <div className="content">
                    <h6><Link legacyBehavior href="/"><a>Alumni Meet 2023 will be on 25th Dec 2023</a></Link></h6>
                    <ul>
                      <li><Link legacyBehavior href="/"><a>Dec 18, 2023</a></Link></li>
                      <li><Link legacyBehavior href="/"><a>Important</a></Link></li>
                    </ul>
                  </div>
                </div>
              </div>
                ...
                <ul className="social-3">

                  {
                    Socials.map((item, index) => (
                      <li key={index}>
                        <a href={item?.link}><span><i className={item?.icon} />{item?.platform}</span><span><strong>VISIT</strong>
                          &nbsp;</span></a>
                      </li>
                    ))
                  }

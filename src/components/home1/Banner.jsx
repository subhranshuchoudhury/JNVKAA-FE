      ...
      <div className="container-fluid">
        <div className="row justify-content-center">
                      ...
                      return (
                        <SwiperSlide key={index} className="swiper-slide">
                          <div className="blog-grid-3">
                            ...
                            <a className="image">
                              {post?.image && <Image style={{ objectFit: "cover" }} fill src={post?.image} alt="image" />}
                            </a>
                          </div>
                        </SwiperSlide>
                      );
          ...
          <div className="col-12 text-center d-flex align-items-center justify-content-center gap-5">
            ...
            <ul className={`nav nav-tabs nav-style-1 justify-content-center ${theme === "dark" ? "nav-pills-padding" : ""}`} role="tablist">

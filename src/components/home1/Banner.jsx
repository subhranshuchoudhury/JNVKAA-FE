                      ...
                      carouselData?.map((post, index) => {
                        ...
                        <img src="/assets/images/authors/author1-1.jpg" alt="image" />
                            ...
                            <div className="content">
                              <ul>
                                <li><Link legacyBehavior href="/"><a>{post?.post_by}</a></Link></li>
                                <li><Link legacyBehavior href="/"><a>{post?.date}</a></Link></li>
                                <li>{post?.views}</li>
                              </ul>
                              <h4><Link legacyBehavior href="/"><a>{post?.title}</a></Link></h4>

                  ...
                  <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                      <div className="blog-grid-3">
                        <Link legacyBehavior href="/blog-classic"><a className="eg-badge badge--red">Alumni Meet</a></Link>
                        ...
                        <div className="content">
                          <ul>
                            <li><Link legacyBehavior href="/author-details"><a>By Subhranshu Choudhury</a></Link></li>
          ...
          <div className="col-12 text-center d-flex align-items-center justify-content-center gap-5">
            ...
            <ul className="nav nav-tabs nav-style-1 justify-content-center" role="tablist">
              <li className="nav-item" role="presentation">
                <a className="nav-link active" data-bs-toggle="tab" href="#tab-one" aria-selected="true" role="tab" tabIndex={-1}>Navodaya Vidyalaya</a>
              </li>

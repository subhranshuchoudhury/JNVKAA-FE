                    ...
                    <SwiperSlide key={index} className="swiper-slide">
                      <div className="author-1">
                        <div className="author-front">
                          ...
                          <h4>{member?.name}</h4>
                          <ul>
                            <li><span>School No:</span><span>{member?.profileDetails.schoolNo}</span></li>
                            <li><span>Blood Group:</span><span>{member?.profileDetails?.bloodGroup}</span></li>
                          </ul>
                        </div>

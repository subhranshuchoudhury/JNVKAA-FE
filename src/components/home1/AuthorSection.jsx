...
import { getLatestFourAlumni } from "@/utils/fetch";
                    ...
                    <SwiperSlide key={index} className="swiper-slide">
                      <div className="author-1">
                        <div className="author-front">
                          <span className="categoty">2022</span>
                          ...
                          <h4>{member?.name}</h4>
                          <ul>
                            <li><span>School No:</span><span>{1023}</span></li>
                            <li><span>Blood Group:</span><span>{"B +VE"}</span></li>
                          </ul>
                        </div>

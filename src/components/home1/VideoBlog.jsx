          ...
          <div className="row align-items-center g-4 mb-40">
            <div className="col-md-9">
              <div className="section-title-1">
                <h2 className={`${theme === "dark" ? "text-light" : ""}`}>Featured Video</h2>
                <div className="subtitle">
                  ...
                  <span className={`${theme === "dark" ? "text-light" : ""}`}>&nbsp;Video Post</span>
                </div>
              </div>
            </div>
            <div className="col-md-3 d-flex justify-content-md-end">
              <Link legacyBehavior href="/posts/youtube"><a className={`eg-btn arrow-btn-2 ${theme === "dark" ? "text-light" : ""}`}>Explore All<i className={`bi bi-arrow-right ${theme === "dark" ?  "border border-white rounded-circle" : ""}`} /></a></Link>
            </div>
          </div>
...

              {
                YoutubeVideos?.length === 3 && <div className="blog-video-1">
                  ...
                  <div className="content">
                    ...
                    <h3><Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[0]?._id}`}><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>{YoutubeVideos?.[0]?.title}</a></Link>
                    </h3>
                    <p>{YoutubeVideos?.[0]?.description}</p>
                    <div className="video-author">
                      <Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[0]?._id}`}><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>By Admin</a></Link>
                      <Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[0]?._id}`}><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>{new Date(YoutubeVideos?.[0]?.date).toLocaleString()}</a></Link>
                    </div>
                  </div>
                </div>
              }
              ...
              YoutubeVideos?.length === 3 && <div className="col-lg-5">
                <div className="video-sidebar">
                  <div className="blog-video-2">
                    ...
                    <div className="content">
                      <ul>
                        <li><Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[1]?._id}`}><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>By Admin</a></Link></li>
                        <li><Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[1]?._id}`}><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>{new Date(YoutubeVideos?.[1]?.date).toLocaleString()}</a></Link></li>
                      </ul>
                      <h3><Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[1]?._id}`}><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>{YoutubeVideos?.[1]?.title}</a></Link>
                      </h3>
                    </div>
                    <div className="bottom-area">
                      ...
                      <Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[1]?._id}`}><a className={`eg-btn arrow-btn ${theme === "dark" ? "text-light" : ""}`}>View Details<i className="bi bi-arrow-right" /></a></Link>
                  ...
                  <div className="blog-video-2">
                    ...
                    <div className="content">
                      <ul>
                        <li><Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[2]?._id}`}><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>By Admin</a></Link></li>
                        <li><Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[2]?._id}`}><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>{new Date(YoutubeVideos?.[2]?.date).toLocaleString()}</a></Link></li>

                      </ul>
                      <h3><Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[2]?._id}`}><a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>{YoutubeVideos?.[2]?.title}</a></Link>
                      </h3>
                    </div>
                    <div className="bottom-area">
                      ...
                      <Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[2]?._id}`}><a className={`eg-btn arrow-btn ${theme === "dark" ? "text-light" : ""}`}>View Details<i className="bi bi-arrow-right" /></a></Link>

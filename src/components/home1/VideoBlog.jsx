...

              {
                YoutubeVideos?.length === 3 && <div className="blog-video-1">
                  ...
                  <div className="content">
                    ...
                    <h3><Link legacyBehavior href="/post-format-no-sidebar-02"><a>{YoutubeVideos?.[0]?.title}</a></Link>
                    </h3>
                ...
                <div className="video-sidebar">
                  <div className="blog-video-2">
                    ...
                    <div className="content">
                      ...
                      <h3><Link legacyBehavior href="/post-format-no-sidebar-02"><a>{YoutubeVideos?.[1]?.title}</a></Link>
                      </h3>
                    </div>
                  ...
                  <div className="blog-video-2">
                    ...
                    <div className="content">
                      ...
                      <h3><Link legacyBehavior href="/post-format-no-sidebar-02"><a>{YoutubeVideos?.[2]?.title}</a></Link>
                      </h3>
                    </div>
                    <div className="bottom-area">
                      <span> <svg width={9} height={12} viewBox="0 0 9 12" xmlns="http://www.w3.org/2000/svg">

        ...
        <div className="container">
          <div className="row align-items-center g-4 mb-40">
            ...
            <div className="col-md-3 d-flex justify-content-md-end">
              <Link legacyBehavior href="/posts/youtube"><a className=" eg-btn arrow-btn-2">Explore All<i className="bi bi-arrow-right" /></a></Link>
            </div>
          </div>
...

              {
                YoutubeVideos?.length === 3 && <div className="blog-video-1">
                  ...
                  <div className="content">
                    ...
                    <h3><Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[0]?._id}`}><a>{YoutubeVideos?.[0]?.title}</a></Link>
                    </h3>
                    <p>{YoutubeVideos?.[0]?.description}</p>
                    <div className="video-author">
                      <Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[0]?._id}`}><a>By Admin</a></Link>
                      <Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[0]?._id}`}><a>{new Date(YoutubeVideos?.[0]?.date).toLocaleString()}</a></Link>
                    </div>
                  </div>
                </div>
              }
              ...
              YoutubeVideos?.length === 3 && <div className="col-lg-5">
                <div className="video-sidebar">
                  <div className="blog-video-2">
                    ...
                    <div className="content">
                      <ul>
                        <li><Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[1]?._id}`}><a>By Admin</a></Link></li>
                        <li><Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[1]?._id}`}><a>{new Date(YoutubeVideos?.[1]?.date).toLocaleString()}</a></Link></li>
                      </ul>
                      <h3><Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[1]?._id}`}><a>{YoutubeVideos?.[1]?.title}</a></Link>
                      </h3>
                    </div>
                    <div className="bottom-area">
                      ...
                      <Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[1]?._id}`}><a className=" eg-btn arrow-btn">View Details<i className="bi bi-arrow-right" /></a></Link>
                  ...
                  <div className="blog-video-2">
                    ...
                    <div className="content">
                      <ul>
                        <li><Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[2]?._id}`}><a>By Admin</a></Link></li>
                        <li><Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[2]?._id}`}><a>{new Date(YoutubeVideos?.[2]?.date).toLocaleString()}</a></Link></li>

                      </ul>
                      <h3><Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[2]?._id}`}><a>{YoutubeVideos?.[2]?.title}</a></Link>
                      </h3>
                    </div>
                    <div className="bottom-area">
                      <span> <svg width={9} height={12} viewBox="0 0 9 12" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <Link legacyBehavior href={`/posts/youtube/id/${YoutubeVideos?.[2]?._id}`}><a className=" eg-btn arrow-btn">View Details<i className="bi bi-arrow-right" /></a></Link>

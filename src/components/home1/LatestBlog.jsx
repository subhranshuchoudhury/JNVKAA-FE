              ...
              <div className="blog-grid-1 sibling-2">
                <div className="content">
                  ...
                  <ul>
                    ...
                    <li><Link legacyBehavior href="/post-format-no-sidebar-02"><a>{data?.date}</a></Link></li>
                    <li><Link legacyBehavior href="/post-format-no-sidebar-02"><a>2.8k View</a></Link></li>
                  </ul>
                  <h5><Link legacyBehavior href="/post-format-no-sidebar-02"><a>{data?.heading}</a></Link></h5>

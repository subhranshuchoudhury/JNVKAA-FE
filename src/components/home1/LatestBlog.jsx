...
import data from '../../data/officials/head.json'
function LatestBlog() {
        ...
        <div className="container">
          <div className="row align-items-center mb-40">
            ...
            <div className="col-lg-3 d-flex justify-content-lg-end justify-content-center">
              <Link legacyBehavior href="/official/president/statement"><a className=" eg-btn arrow-btn-2 mt-lg-0 mt-4">Read Post<i className="bi bi-arrow-right" /></a></Link>
            </div>
          </div>
            ...
            <div className="col-lg-4 col-md-6 col-sm-10">
              <div className="blog-grid-1 sibling-2">
                <div className="content">
                  <span className="eg-badge badge--red">{data?.title}</span>
                  <ul>
                    <li><Link legacyBehavior href="/official/president/statement"><a>{data?.date}</a></Link></li>
                    <li><Link legacyBehavior href="/official/president/statement"><a>Official</a></Link></li>
                  </ul>
                  <h5><Link legacyBehavior href="/official/president/statement"><a>"{data?.heading}"</a></Link></h5>
                  <div className="bottom-area">
                    <Link legacyBehavior href="/official/president/statement"><a className=" eg-btn arrow-btn">Read Post<i className="bi bi-arrow-right" /></a></Link>
                ...
                <div className="content">
                  <span className="eg-badge badge--red">{data?.name}</span>

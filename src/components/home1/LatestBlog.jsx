...
import headOfficials from "@/data/officials/head.json";
          ...
          <div className="row align-items-center mb-40">
            <div className="col-lg-9 text-lg-start text-center">
              <div className="section-title-1">
                <h2 className={`${theme === "dark" ? "text-light" : ""}`}>Officials</h2>
                <div className="subtitle justify-content-lg-start justify-content-center">
                  ...
                  <span className={`${theme === "dark" ? "text-light" : ""}`}>&nbsp;People behind the association</span>
                </div>
              </div>
            </div>
              ...
              headOfficials.map((official, index) => {
                return <div key={index} className="col-lg-4 col-md-6 col-sm-10">
                  <div className="blog-grid-1 sibling-2">
                    ...
                    <Link legacyBehavior href={`/official/president/statement/id/${official?.id}`}>
                      <a className="image">
                        <img
                          src={official?.image}
                          alt="image"
                      ...
                      <ul>
                        <li>
                          <Link legacyBehavior href="/author-details">
                            <a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>Official</a>
                          </Link>
                        </li>
                        <li>
                          <Link legacyBehavior href={`/official/president/statement/id/${official?.id}`}>
                            <a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>{official?.date}</a>
                          </Link>
                        </li>
                        <li>
                          <Link legacyBehavior href={`/official/president/statement/id/${official?.id}`}>
                            <a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>By {official?.name}</a>
                          </Link>
                        </li>
                      </ul>
                      <h4>
                        <Link legacyBehavior href={`/official/president/statement/id/${official?.id}`}>
                          <a className={`${theme === "dark" ? "text-light text-hover" : ""}`}>{official?.heading}</a>
                        </Link>
                      </h4>
